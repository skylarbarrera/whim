...
export async function createPullRequest(
  ...
  const prBodyParts: string[] = [
    "## Summary",
    "",
    `This PR was automatically generated by AI Factory to address ${issueNumber ? `issue #${issueNumber}` : "a work item"}.`,
    "",
  ];
